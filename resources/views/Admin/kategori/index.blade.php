...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="{{route('recipe.create') }}"><i class="fas fa-book"></i>Resep</a>
        <a href="{{route('kategori.create') }}"><i class="fas fa-book"></i>Tambah Kategori</a>
                ...
                <tbody>
                    @foreach($kategori as $kategori)
                        <tr>
                            ...
                            <td>{{ $kategori->nama}}</td>
                            <td>
                                <a href="{{ route('kategori.edit', $kategori->id) }}" style="color: #007bff; text-decoration: none;">Edit</a> |
                                <form action="{{ route('kategori.destroy', $kategori->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" style="background-color: transparent; border: none; color: red; cursor: pointer;">Hapus</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
