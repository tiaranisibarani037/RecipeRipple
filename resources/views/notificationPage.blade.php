...
<body>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="#" onclick="toggleProfilePopup()">
                        <img src="{{ asset('frontend/images/profile1.jpg') }}" alt="User Profile"
    ...
    <div class="container notification-container">
        <div class="row">
            ...
            <div class="col-12">
                ...
                @else
                    ...
                    @foreach ($unreads as $unread)
                        <form action="{{ route('notifications.read', $unread->id) }}" method="POST"
            ...
            <div class="col-12">
                <p class="col-12 text-start" style="font-family: 'Montserrat', sans-serif">Sudah dibaca</p>
                @if ($reads->isEmpty())
                    <!-- Tampilkan pesan jika tidak ada komentar yang sudah dibaca -->
                    <p class="text-muted">Tidak ada notifikasi yang sudah dibaca</p>
                @else
                    <!-- Tampilkan daftar komentar yang sudah dibaca -->
